...
var FontRendererFactory = function FontRendererFactoryClosure() {
  ...
  function parseCmap(data, start, end) {
    ...
    throw new _util_metapdf.FormatError("unsupported cmap: ".concat(format));
  }
        ...
        switch (v) {
          ...
          case 12:
            ...
            switch (v) {
              ...
              default:
                throw new _util_metapdf.FormatError("unknown operator: 12 ".concat(v));
            }
          ...
          default:
            if (v < 32) {
              throw new _util_metapdf.FormatError("unknown operator: ".concat(v));
            }
  ...
  var CompiledFont = /*#__PURE__*/function () {
    function CompiledFont(fontMatrix) {
      ...
      if (this.constructor === CompiledFont) {
        (0, _util_metapdf.unreachable)("Cannot initialize CompiledFont.");
      }
    ...
    _createClass(CompiledFont, [{
      ...
      value: function compileGlyph(code, glyphId) {
        ...
        if (this.isCFFCIDFont) {
          ...
          if (fdIndex >= 0 && fdIndex < this.fdArray.length) {
            ...
            fontMatrix = fontDict.getByName("FontMatrix") || _util_metapdf.FONT_IDENTITY_MATRIX;
          } else {
            (0, _util_metapdf.warn)("Invalid fd index for glyph index.");
          }
        }
      ...
      value: function compileGlyphImpl() {
        (0, _util_metapdf.unreachable)("Children classes should implement this.");
      }
    }, {
      key: "hasBuiltPath",
  ...
  return {
    create: function FontRendererFactory_create(font, seacAnalysisEnabled) {
      ...
      for (var i = 0, p = 12; i < numTables; i++, p += 16) {
        var tag = (0, _util_metapdf.bytesToString)(data.subarray(p, p + 4));
