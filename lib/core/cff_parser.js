    ...
    _createClass(CFFParser, [{
      ...
      value: function parseHeader() {
        ...
        if (offset >= bytesLength) {
          throw new _util_metapdf.FormatError("Invalid CFF header");
        }

        if (offset !== 0) {
          (0, _util_metapdf.info)("cff data is shifted");
      ...
      value: function parseDict(dict) {
        ...
        function parseOperand() {
          ...
          (0, _util_metapdf.warn)('CFFParser_parseDict: "' + value + '" is a reserved command.');
          return NaN;
        }
      ...
      value: function parseNameIndex(index) {
        ...
        for (var i = 0, ii = index.count; i < ii; ++i) {
          ...
          names.push((0, _util_metapdf.bytesToString)(name));
        }
      ...
      value: function parseStringIndex(index) {
        ...
        for (var i = 0, ii = index.count; i < ii; ++i) {
          ...
          strings.add((0, _util_metapdf.bytesToString)(data));
        }
      ...
      value: function parseCharString(state, data, localSubrIndex, globalSubrIndex) {
        ...
        for (var j = 0; j < length;) {
          ...
          if (value === 12) {
            ...
            if (!subrsIndex) {
              validationCommand = CharstringValidationData[value];
              (0, _util_metapdf.warn)("Missing subrsIndex for " + validationCommand.id);
              return false;
            }
            ...
            if (subrNumber < 0 || subrNumber >= subrsIndex.count || isNaN(subrNumber)) {
              validationCommand = CharstringValidationData[value];
              (0, _util_metapdf.warn)("Out of bounds subrIndex for " + validationCommand.id);
              return false;
            }
          ...
          if (validationCommand) {
            if (validationCommand.stem) {
              ...
              if (value === 3 || value === 23) {
                ...
                (0, _util_metapdf.warn)("CFF stem hints are in wrong order");
            ...
            if ("min" in validationCommand) {
              if (!state.undefStack && stackSize < validationCommand.min) {
                (0, _util_metapdf.warn)("Not enough parameters for " + validationCommand.id + "; actual: " + stackSize + ", expected: " + validationCommand.min);
                return false;
              }
            }
            ...
            if (state.firstStackClearing && validationCommand.stackClearing) {
              ...
              if (stackSize >= 2 && validationCommand.stem) {
                ...
                (0, _util_metapdf.warn)("Found too many parameters for stack-clearing command");
              }
      ...
      value: function parseCharStrings(_ref) {
        ...
        for (var i = 0; i < count; i++) {
          ...
          if (fdSelect && fdArray.length) {
            ...
            if (fdIndex === -1) {
              (0, _util_metapdf.warn)("Glyph index is not in fd select.");
              valid = false;
            }

            if (fdIndex >= fdArray.length) {
              (0, _util_metapdf.warn)("Invalid fd index for glyph index.");
              valid = false;
            }
      ...
      value: function parseCharsets(pos, length, strings, cid) {
        ...
        switch (format) {
          ...
          default:
            throw new _util_metapdf.FormatError("Unknown charset format");
        }
      ...
      value: function parseEncoding(pos, properties, strings, charset) {
        ...
        if (pos === 0 || pos === 1) {
          ...
          switch (format & 0x7f) {
            ...
            default:
              throw new _util_metapdf.FormatError("Unknown encoding format: ".concat(format, " in CFF"));
          }
        ...
        switch (format) {
          ...
          case 3:
            ...
            for (i = 0; i < rangesCount; ++i) {
              ...
              if (i === 0 && first !== 0) {
                (0, _util_metapdf.warn)("parseFDSelect: The first range must have a first GID of 0" + " -- trying to recover.");
                first = 0;
              }
          ...
          default:
            throw new _util_metapdf.FormatError("parseFDSelect: Unknown format \"".concat(format, "\"."));
        }

        if (fdSelect.length !== length) {
          throw new _util_metapdf.FormatError("parseFDSelect: Invalid font data.");
        }
  ...
  _createClass(CFF, [{
    ...
    value: function duplicateFirstGlyph() {
      if (this.charStrings.count >= 65535) {
        (0, _util_metapdf.warn)("Not enough space in charstrings to duplicate first glyph.");
        return;
      }
  ...
  _createClass(CFFDict, [{
    ...
    value: function setByKey(key, value) {
      ...
      for (var i = 0; i < valueLength; i++) {
        if (isNaN(value[i])) {
          (0, _util_metapdf.warn)('Invalid CFFDict value: "' + value + '" for key "' + key + '".');
          return true;
        }
      }
    ...
    value: function setByName(name, value) {
      if (!(name in this.nameToKeyMap)) {
        throw new _util_metapdf.FormatError("Invalid dictionary name \"".concat(name, "\""));
      }
  ...
  _createClass(CFFOffsetTracker, [{
    ...
    value: function track(key, location) {
      if (key in this.offsets) {
        throw new _util_metapdf.FormatError("Already tracking location of ".concat(key));
      }
    ...
    value: function setEntryLocation(key, values, output) {
      if (!(key in this.offsets)) {
        throw new _util_metapdf.FormatError("Not tracking location of ".concat(key));
      }
      ...
      for (var i = 0, ii = values.length; i < ii; ++i) {
        ...
        if (data[offset0] !== 0x1d || data[offset1] !== 0 || data[offset2] !== 0 || data[offset3] !== 0 || data[offset4] !== 0) {
          throw new _util_metapdf.FormatError("writing to an offset that is not empty");
        }
  ...
  _createClass(CFFCompiler, [{
        ...
        if (cff.topDict.hasName("FontMatrix")) {
          ...
          for (var i = 0, ii = cff.fdArray.length; i < ii; i++) {
            ...
            if (subDict.hasName("FontMatrix")) {
              matrix = _util_metapdf.Util.transform(matrix, subDict.getByName("FontMatrix"));
            }
    ...
    value: function compileNameIndex(names) {
      ...
      for (var i = 0, ii = names.length; i < ii; ++i) {
        ...
        nameIndex.add((0, _util_metapdf.stringToBytes)(sanitizedName));
      }
    ...
    value: function compilePrivateDicts(dicts, trackers, output) {
      for (var i = 0, ii = dicts.length; i < ii; ++i) {
        ...
        if (!privateDict || !fontDict.hasName("Private")) {
          throw new _util_metapdf.FormatError("There must be a private dictionary.");
        }
      ...
      for (var i = 0; i < order.length; ++i) {
        ...
        for (var j = 0, jj = types.length; j < jj; ++j) {
          ...
          switch (type) {
            ...
            default:
              throw new _util_metapdf.FormatError("Unknown data type of ".concat(type));
          }
        }
    ...
    value: function compileStringIndex(strings) {
      ...
      for (var i = 0, ii = strings.length; i < ii; ++i) {
        stringIndex.add((0, _util_metapdf.stringToBytes)(strings[i]));
      }
        ...
        for (var i = 1; i < out.length; i += 2) {
          ...
          if (charsetIndex < numCharsets) {
            ...
            if (sid === -1) {
              ...
              if (!warned) {
                warned = true;
                (0, _util_metapdf.warn)("Couldn't find ".concat(name, " in CFF strings"));
              }
            }
          }
    ...
    get: function get() {
      return (0, _util_metapdf.shadow)(this, "EncodeFloatRegExp", /\.(\d*?)(?:9{5,20}|0{5,20})\d{0,2}(?:e(.+)|$)/);
    }
  }]);
