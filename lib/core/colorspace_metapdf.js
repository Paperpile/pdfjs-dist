...
var ColorSpace = /*#__PURE__*/function () {
  function ColorSpace(name, numComps) {
    ...
    if (this.constructor === ColorSpace) {
      (0, _util_metapdf.unreachable)("Cannot initialize ColorSpace.");
    }
  ...
  _createClass(ColorSpace, [{
    ...
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      (0, _util_metapdf.unreachable)("Should not call ColorSpace.getRgbItem");
    }
  }, {
    key: "getRgbBuffer",
    value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
      (0, _util_metapdf.unreachable)("Should not call ColorSpace.getRgbBuffer");
    }
  }, {
    key: "getOutputLength",
    value: function getOutputLength(inputLength, alpha01) {
      (0, _util_metapdf.unreachable)("Should not call ColorSpace.getOutputLength");
    }
  }, {
    key: "isPassthrough",
    ...
    get: function get() {
      return (0, _util_metapdf.shadow)(this, "usesZeroToOneRange", true);
    }
  }], [{
    key: "_cache",
      ...
      if ((0, _primitives.isName)(cs)) {
        switch (cs.name) {
          ...
          default:
            ...
            throw new _util_metapdf.FormatError("Unrecognized ColorSpace: ".concat(cs.name));
        }
      }
        ...
        switch (mode) {
          ...
          case "ICCBased":
            ...
            if (alt) {
              ...
              (0, _util_metapdf.warn)("ICCBased color space: Ignoring incorrect /Alternate entry.");
            }
          ...
          default:
            throw new _util_metapdf.FormatError("Unimplemented ColorSpace object: ".concat(mode));
        }
      }

      throw new _util_metapdf.FormatError("Unrecognized ColorSpace object: ".concat(cs));
    }
  }, {
    key: "isDefaultDecode",
    value: function isDefaultDecode(decode, numComps) {
      ...
      if (numComps * 2 !== decode.length) {
        (0, _util_metapdf.warn)("The decode map is not the correct length");
        return true;
      }
    ...
    key: "singletons",
    get: function get() {
      return (0, _util_metapdf.shadow)(this, "singletons", {
        get gray() {
          return (0, _util_metapdf.shadow)(this, "gray", new DeviceGrayCS());
        },

        get rgb() {
          return (0, _util_metapdf.shadow)(this, "rgb", new DeviceRgbCS());
        },

        get cmyk() {
          return (0, _util_metapdf.shadow)(this, "cmyk", new DeviceCmykCS());
        }
...
var PatternCS = /*#__PURE__*/function (_ColorSpace2) {
  ...
  _createClass(PatternCS, [{
    key: "isDefaultDecode",
    value: function isDefaultDecode(decodeMap, bpc) {
      (0, _util_metapdf.unreachable)("Should not call PatternCS.isDefaultDecode");
    }
  }]);
...
var IndexedCS = /*#__PURE__*/function (_ColorSpace3) {
  ...
  function IndexedCS(base, highVal, lookup) {
    ...
    if ((0, _primitives.isStream)(lookup)) {
      ...
      throw new _util_metapdf.FormatError("IndexedCS - unrecognized lookup table: ".concat(lookup));
    }
  ...
  _createClass(IndexedCS, [{
    ...
    value: function isDefaultDecode(decodeMap, bpc) {
      ...
      if (decodeMap.length !== 2) {
        (0, _util_metapdf.warn)("Decode map length is not correct");
        return true;
      }

      if (!Number.isInteger(bpc) || bpc < 1) {
        (0, _util_metapdf.warn)("Bits per component is not correct");
        return true;
      }
...
var DeviceRgbCS = /*#__PURE__*/function (_ColorSpace5) {
  ...
  _createClass(DeviceRgbCS, [{
    key: "getRgbItem",
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      var r = src[srcOffset] * 255 + 0.1 | 0;
      var g = src[srcOffset + 1] * 255 + 0.1 | 0;
      var b = src[srcOffset + 2] * 255 + 0.1 | 0;
...
var CalGrayCS = function CalGrayCSClosure() {
  ...
  var CalGrayCS = /*#__PURE__*/function (_ColorSpace7) {
    ...
    function CalGrayCS(whitePoint, blackPoint, gamma) {
      ...
      if (!whitePoint) {
        throw new _util_metapdf.FormatError("WhitePoint missing - required for color space CalGray");
      }
      ...
      if (_this4.XW < 0 || _this4.ZW < 0 || _this4.YW !== 1) {
        throw new _util_metapdf.FormatError("Invalid WhitePoint components for ".concat(_this4.name) + ", no fallback available");
      }

      if (_this4.XB < 0 || _this4.YB < 0 || _this4.ZB < 0) {
        (0, _util_metapdf.info)("Invalid BlackPoint for ".concat(_this4.name, ", falling back to default."));
        _this4.XB = _this4.YB = _this4.ZB = 0;
      }

      if (_this4.XB !== 0 || _this4.YB !== 0 || _this4.ZB !== 0) {
        (0, _util_metapdf.warn)("".concat(_this4.name, ", BlackPoint: XB: ").concat(_this4.XB, ", YB: ").concat(_this4.YB, ", ") + "ZB: ".concat(_this4.ZB, ", only default values are supported."));
      }

      if (_this4.G < 1) {
        (0, _util_metapdf.info)("Invalid Gamma: ".concat(_this4.G, " for ").concat(_this4.name, ", ") + "falling back to default.");
        _this4.G = 1;
      }
...
var CalRGBCS = function CalRGBCSClosure() {
  ...
  var CalRGBCS = /*#__PURE__*/function (_ColorSpace8) {
    ...
    function CalRGBCS(whitePoint, blackPoint, gamma, matrix) {
      ...
      if (!whitePoint) {
        throw new _util_metapdf.FormatError("WhitePoint missing - required for color space CalRGB");
      }
      ...
      if (XW < 0 || ZW < 0 || YW !== 1) {
        throw new _util_metapdf.FormatError("Invalid WhitePoint components for ".concat(_this5.name) + ", no fallback available");
      }

      if (XB < 0 || YB < 0 || ZB < 0) {
        (0, _util_metapdf.info)("Invalid BlackPoint for ".concat(_this5.name, " [").concat(XB, ", ").concat(YB, ", ").concat(ZB, "], ") + "falling back to default.");
        _this5.blackPoint = new Float32Array(3);
      }

      if (_this5.GR < 0 || _this5.GG < 0 || _this5.GB < 0) {
        (0, _util_metapdf.info)("Invalid Gamma [".concat(_this5.GR, ", ").concat(_this5.GG, ", ").concat(_this5.GB, "] for ") + "".concat(_this5.name, ", falling back to default."));
...
var LabCS = function LabCSClosure() {
  ...
  var LabCS = /*#__PURE__*/function (_ColorSpace9) {
    ...
    function LabCS(whitePoint, blackPoint, range) {
      ...
      if (!whitePoint) {
        throw new _util_metapdf.FormatError("WhitePoint missing - required for color space Lab");
      }
      ...
      if (_this6.XW < 0 || _this6.ZW < 0 || _this6.YW !== 1) {
        throw new _util_metapdf.FormatError("Invalid WhitePoint components, no fallback available");
      }

      if (_this6.XB < 0 || _this6.YB < 0 || _this6.ZB < 0) {
        (0, _util_metapdf.info)("Invalid BlackPoint, falling back to default");
        _this6.XB = _this6.YB = _this6.ZB = 0;
      }

      if (_this6.amin > _this6.amax || _this6.bmin > _this6.bmax) {
        (0, _util_metapdf.info)("Invalid Range, falling back to defaults");
        _this6.amin = -100;
        _this6.amax = 100;
        _this6.bmin = -100;
        _this6.bmax = 100;
    ...
    _createClass(LabCS, [{
      ...
      key: "usesZeroToOneRange",
      get: function get() {
        return (0, _util_metapdf.shadow)(this, "usesZeroToOneRange", false);
      }
    }]);
