...
var PDFFunction = function PDFFunctionClosure() {
  ...
  return {
    ...
    getIR: function getIR(_ref2) {
      ...
      if (!typeFn) {
        throw new _util_metapdf.FormatError("Unknown type of function");
      }
    ...
    constructSampled: function constructSampled(_ref6) {
      ...
      if (!domain || !range) {
        throw new _util_metapdf.FormatError("No domain or range");
      }
      ...
      if (order !== 1) {
        (0, _util_metapdf.info)("No support for cubic spline interpolation: " + order);
      }
    ...
    constructStiched: function constructStiched(_ref10) {
      ...
      if (!domain) {
        throw new _util_metapdf.FormatError("No domain");
      }

      var inputSize = domain.length / 2;

      if (inputSize !== 1) {
        throw new _util_metapdf.FormatError("Bad domain for stiched function");
      }
    ...
    constructPostScript: function constructPostScript(_ref12) {
      ...
      if (!range) {
        throw new _util_metapdf.FormatError("No range.");
      }
    ...
    constructPostScriptFromIR: function constructPostScriptFromIR(_ref13) {
      ...
      if (isEvalSupported && _util_metapdf.IsEvalSupportedCached.value) {
      ...
      (0, _util_metapdf.info)("Unable to compile PS function");
      ...
      while (counter < length) {
        ...
        switch (operator) {
          ...
          case "and":
            ...
            if ((0, _util_metapdf.isBool)(a) && (0, _util_metapdf.isBool)(b)) {
              stack.push(a && b);
            } else {
              stack.push(a & b);
            }
          ...
          default:
            throw new _util_metapdf.FormatError("Unknown operator ".concat(operator));
        }
      }
...
var PostScriptCompiler = function PostScriptCompilerClosure() {
  ...
  AstNode.prototype.visit = function (visitor) {
    (0, _util_metapdf.unreachable)("abstract method");
  };
