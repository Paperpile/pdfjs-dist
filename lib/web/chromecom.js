    ...
    if (/^file?:/.test(file)) {
      getEmbedderOrigin(function (origin) {
        if (origin && !/^file:|^chrome-extension:/.test(origin)) {
          _app_metapdf.PDFViewerApplication.error("Blocked " + origin + " from loading " + file + ". Refused to load a local file in a non-local page " + "for security reasons.");
...
var ChromeExternalServices = /*#__PURE__*/function (_DefaultExternalServi) {
  ...
  _createClass(ChromeExternalServices, null, [{
    ...
    value: function initPassiveLoading(callbacks) {
      ChromeCom.resolvePDFFile(_app_options.AppOptions.get("defaultUrl"), _app_metapdf.PDFViewerApplication.overlayManager, function (url, length, originalUrl) {
...
_app_metapdf.PDFViewerApplication.externalServices = ChromeExternalServices;