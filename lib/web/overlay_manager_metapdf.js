          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 14:
                ...
                this._overlays[this._active].element.classList.remove('mp-hidden');

                this._overlays[this._active].container.classList.remove('mp-hidden');
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                this._overlays[this._active].container.classList.add('mp-hidden');

                this._overlays[this._active].element.classList.add('mp-hidden');
