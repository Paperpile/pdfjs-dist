...
var PDFDocumentProperties = /*#__PURE__*/function () {
  function PDFDocumentProperties(_ref, overlayManager, eventBus) {
    ...
    var l10n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _ui_utils_metapdf.NullL10n;
  ...
  _createClass(PDFDocumentProperties, [{
    ...
    value: function open() {
      ...
      Promise.all([this._dataAvailableCapability.promise]).then(function () {
        ...
        _this2.pdfDocument.getMetadata().then(function (_ref2) {
          ...
          return Promise.all([info, metadata, contentDispositionFilename || (0, _ui_utils_metapdf.getPDFFileNameFromURL)(_this2.url), _this2._parseFileSize(_this2.maybeFileSize), _this2._parseDate(info.CreationDate), _this2._parseDate(info.ModDate), _this2.pdfDocument.getPage(currentPageNumber).then(function (pdfPage) {
            return _this2._parsePageSize((0, _ui_utils_metapdf.getPageSizeInches)(pdfPage), pagesRotation);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                return _context.abrupt("return", (+kb.toPrecision(3)).toLocaleString() + ' KB (' + fileSize.toLocaleString() + ' bytes)');

              case 8:
                return _context.abrupt("return", (+(kb / 1024).toPrecision(3)).toLocaleString() + ' MB (' + fileSize.toLocaleString() + ' bytes)');
