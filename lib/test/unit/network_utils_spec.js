...
describe("network_utils", function () {
  ...
  describe("createResponseStatusError", function () {
    it("handles missing PDF file responses", function () {
      expect((0, _network_utils.createResponseStatusError)(404, "https://foo.com/bar.pdf")).toEqual(new _util_metapdf.MissingPDFException('Missing PDF "https://foo.com/bar.pdf".'));
      expect((0, _network_utils.createResponseStatusError)(0, "file://foo.pdf")).toEqual(new _util_metapdf.MissingPDFException('Missing PDF "file://foo.pdf".'));
    });
    it("handles unexpected responses", function () {
      expect((0, _network_utils.createResponseStatusError)(302, "https://foo.com/bar.pdf")).toEqual(new _util_metapdf.UnexpectedResponseException("Unexpected server response (302) while retrieving PDF " + '"https://foo.com/bar.pdf".'));
      expect((0, _network_utils.createResponseStatusError)(0, "https://foo.com/bar.pdf")).toEqual(new _util_metapdf.UnexpectedResponseException("Unexpected server response (0) while retrieving PDF " + '"https://foo.com/bar.pdf".'));
    });
  });
