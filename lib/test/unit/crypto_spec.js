...
var _crypto_metapdf = require("../../core/crypto_metapdf.js");
...
describe("crypto", function () {
  ...
  describe("ARCFourCipher", function () {
    it("should pass test #1", function () {
      ...
      var cipher = new _crypto_metapdf.ARCFourCipher(key);
  ...
  describe("calculateSHA256", function () {
    it("should properly hash abc", function () {
      var input = (0, _util_metapdf.stringToBytes)("abc");
      var result = (0, _crypto_metapdf.calculateSHA256)(input, 0, input.length);
    ...
    it("should properly hash a multiblock input", function () {
      var input = (0, _util_metapdf.stringToBytes)("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
      var result = (0, _crypto_metapdf.calculateSHA256)(input, 0, input.length);
  ...
  describe("calculateSHA384", function () {
    it("should properly hash abc", function () {
      var input = (0, _util_metapdf.stringToBytes)("abc");
      var result = (0, _crypto_metapdf.calculateSHA384)(input, 0, input.length);
    ...
    it("should properly hash a multiblock input", function () {
      var input = (0, _util_metapdf.stringToBytes)("abcdefghbcdefghicdefghijdefghijkefghijklfghijklm" + "ghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrs" + "mnopqrstnopqrstu");
      var result = (0, _crypto_metapdf.calculateSHA384)(input, 0, input.length);
  ...
  describe("calculateSHA512", function () {
    it("should properly hash abc", function () {
      var input = (0, _util_metapdf.stringToBytes)("abc");
      var result = (0, _crypto_metapdf.calculateSHA512)(input, 0, input.length);
  ...
  describe("AES128", function () {
    describe("Encryption", function () {
      it("should be able to encrypt a block", function () {
        ...
        var cipher = new _crypto_metapdf.AES128Cipher(key);
  ...
  describe("AES256", function () {
    describe("Encryption", function () {
      it("should be able to encrypt a block", function () {
        ...
        var iv = hex2binary("00000000000000000000000000000000");
        var cipher = new _crypto_metapdf.AES256Cipher(key);
        var result = cipher.encrypt(input, iv);
  ...
  describe("PDF17Algorithm", function () {
    it("should correctly check a user key", function () {
      var alg = new _crypto_metapdf.PDF17();
  ...
  describe("PDF20Algorithm", function () {
    it("should correctly check a user key", function () {
      var alg = new _crypto_metapdf.PDF20();
      var password = new Uint8Array([117, 115, 101, 114]);
...
describe("CipherTransformFactory", function () {
  ...
  function ensurePasswordCorrect(done, dict, fileId, password) {
    try {
      var factory = new _crypto_metapdf.CipherTransformFactory(dict, fileId, password);
  ...
  function ensurePasswordNeeded(done, dict, fileId, password) {
    try {
      new _crypto_metapdf.CipherTransformFactory(dict, fileId, password);
    } catch (ex) {
      expect(ex instanceof _util_metapdf.PasswordException).toEqual(true);
      expect(ex.code).toEqual(_util_metapdf.PasswordResponses.NEED_PASSWORD);
      done();
      return;
    }
  ...
  function ensurePasswordIncorrect(done, dict, fileId, password) {
    try {
      ...
      expect(ex instanceof _util_metapdf.PasswordException).toEqual(true);
      expect(ex.code).toEqual(_util_metapdf.PasswordResponses.INCORRECT_PASSWORD);
      done();
      return;
    }
