...
var _ui_utils_metapdf = require("../../web/ui_utils_metapdf.js");
...
describe("api", function () {
  ...
  describe("getDocument", function () {
    it("creates pdf doc from URL", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)(basicApiGetDocumentParams);
      var progressReportedCapability = (0, _util_metapdf.createPromiseCapability)();
      ...
      Promise.all(promises).then(function (data) {
        ...
        expect(data[1] instanceof _api_metapdf.PDFDocumentProxy).toEqual(true);
    ...
    it("creates pdf doc from typed array", function (done) {
      ...
      typedArrayPdfPromise.then(function (typedArrayPdf) {
        ...
        var loadingTask = (0, _api_metapdf.getDocument)(typedArrayPdf);
        var progressReportedCapability = (0, _util_metapdf.createPromiseCapability)();
        ...
        return Promise.all([loadingTask.promise, progressReportedCapability.promise]).then(function (data) {
          expect(data[0] instanceof _api_metapdf.PDFDocumentProxy).toEqual(true);
    ...
    it("creates pdf doc from invalid PDF file", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("bug1020226.pdf"));
      loadingTask.promise.then(function () {
        done.fail("shall fail loading");
      })["catch"](function (reason) {
        expect(reason instanceof _util_metapdf.InvalidPDFException).toEqual(true);
        expect(reason.message).toEqual("Invalid PDF structure.");
        loadingTask.destroy().then(done);
      });
    });
    it("creates pdf doc from non-existent URL", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("non-existent.pdf"));
      loadingTask.promise.then(function (error) {
        done.fail("shall fail loading");
      })["catch"](function (error) {
        expect(error instanceof _util_metapdf.MissingPDFException).toEqual(true);
        loadingTask.destroy().then(done);
      });
    });
    it("creates pdf doc from PDF file protected with user and owner password", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("pr6531_1.pdf"));
      var passwordNeededCapability = (0, _util_metapdf.createPromiseCapability)();
      var passwordIncorrectCapability = (0, _util_metapdf.createPromiseCapability)();

      loadingTask.onPassword = function (updatePassword, reason) {
        if (reason === _util_metapdf.PasswordResponses.NEED_PASSWORD && !passwordNeededCapability.settled) {
          passwordNeededCapability.resolve();
          updatePassword("qwerty");
          return;
        }

        if (reason === _util_metapdf.PasswordResponses.INCORRECT_PASSWORD && !passwordIncorrectCapability.settled) {
      ...
      Promise.all(promises).then(function (data) {
        expect(data[2] instanceof _api_metapdf.PDFDocumentProxy).toEqual(true);
        loadingTask.destroy().then(done);
      })["catch"](done.fail);
    });
    it("creates pdf doc from PDF file protected with only a user password", function (done) {
      var filename = "pr6531_2.pdf";
      var passwordNeededLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename, {
        password: ""
      }));
      var result1 = passwordNeededLoadingTask.promise.then(function () {
        ...
        expect(data instanceof _util_metapdf.PasswordException).toEqual(true);
        expect(data.code).toEqual(_util_metapdf.PasswordResponses.NEED_PASSWORD);
        return passwordNeededLoadingTask.destroy();
      });
      var passwordIncorrectLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename, {
        password: "qwerty"
      }));
      var result2 = passwordIncorrectLoadingTask.promise.then(function () {
        ...
        expect(data instanceof _util_metapdf.PasswordException).toEqual(true);
        expect(data.code).toEqual(_util_metapdf.PasswordResponses.INCORRECT_PASSWORD);
        return passwordIncorrectLoadingTask.destroy();
      });
      var passwordAcceptedLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename, {
        password: "asdfasdf"
      }));
      var result3 = passwordAcceptedLoadingTask.promise.then(function (data) {
        expect(data instanceof _api_metapdf.PDFDocumentProxy).toEqual(true);
    ...
    it("creates pdf doc from password protected PDF file and aborts/throws " + "in the onPassword callback (issue 7806)", function (done) {
      ...
      passwordNeededLoadingTask.onPassword = function (callback, reason) {
        if (reason === _util_metapdf.PasswordResponses.NEED_PASSWORD) {
      ...
      var result1 = passwordNeededLoadingTask.promise.then(function () {
        ...
        expect(reason instanceof _util_metapdf.PasswordException).toEqual(true);
        expect(reason.code).toEqual(_util_metapdf.PasswordResponses.NEED_PASSWORD);
        return passwordNeededDestroyed;
      });

      passwordIncorrectLoadingTask.onPassword = function (callback, reason) {
        if (reason === _util_metapdf.PasswordResponses.INCORRECT_PASSWORD) {
      ...
      var result2 = passwordIncorrectLoadingTask.promise.then(function () {
        ...
        expect(reason instanceof _util_metapdf.PasswordException).toEqual(true);
        expect(reason.code).toEqual(_util_metapdf.PasswordResponses.INCORRECT_PASSWORD);
        return passwordIncorrectLoadingTask.destroy();
      });
    ...
    it("creates pdf doc from empty typed array", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)(new Uint8Array(0));
      loadingTask.promise.then(function () {
        done.fail("shall not open empty file");
      }, function (reason) {
        expect(reason instanceof _util_metapdf.InvalidPDFException);
  ...
  describe("PDFWorker", function () {
    it("worker created or destroyed", function (done) {
      ...
      var worker = new _api_metapdf.PDFWorker({
        name: "test1"
      });
    ...
    it("worker created and can be used in getDocument", function (done) {
      ...
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(basicApiFileName, {
        worker: worker
      }));
      loadingTask.promise.then(function () {
    ...
    it("creates more than one worker", function (done) {
      ...
      var worker1 = new _api_metapdf.PDFWorker({
        name: "test1"
      });
      var worker2 = new _api_metapdf.PDFWorker({
        name: "test2"
      });
      var worker3 = new _api_metapdf.PDFWorker({
        name: "test3"
      });
    ...
    it("gets current workerSrc", function () {
      ...
      var workerSrc = _api_metapdf.PDFWorker.getWorkerSrc();
  ...
  describe("PDFDocument", function () {
    ...
    beforeAll(function (done) {
      pdfLoadingTask = (0, _api_metapdf.getDocument)(basicApiGetDocumentParams);
    ...
    it("gets page", function (done) {
      ...
      promise.then(function (data) {
        expect(data instanceof _api_metapdf.PDFPageProxy).toEqual(true);
    ...
    it("gets page, from /Pages tree with circular reference", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("Pages-tree-refs.pdf"));
      var page1 = loadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getPage(1).then(function (pdfPage) {
          expect(pdfPage instanceof _api_metapdf.PDFPageProxy).toEqual(true);
    ...
    it("gets destinations, from /Names (NameTree) dictionary", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue6204.pdf"));
    ...
    it("gets page labels", function (done) {
      var loadingTask0 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("bug793632.pdf"));
      var promise0 = loadingTask0.promise.then(function (pdfDoc) {
        return pdfDoc.getPageLabels();
      });
      var loadingTask1 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue1453.pdf"));
      var promise1 = loadingTask1.promise.then(function (pdfDoc) {
        return pdfDoc.getPageLabels();
      });
      var loadingTask2 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("rotation.pdf"));
      var promise2 = loadingTask2.promise.then(function (pdfDoc) {
        return pdfDoc.getPageLabels();
      });
      var loadingTask3 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("bad-PageLabels.pdf"));
    ...
    it("gets default page layout", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("tracemonkey.pdf"));
    ...
    it("gets non-default open action (with Print action)", function (done) {
      var loadingTask1 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("bug1001080.pdf"));
      var loadingTask2 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue11442_reduced.pdf"));
      var promise1 = loadingTask1.promise.then(function (pdfDoc) {
        return pdfDoc.getOpenAction();
      }).then(function (openAction) {
    ...
    it("gets attachments", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("attachment.pdf"));
      var promise = loadingTask.promise.then(function (pdfDoc) {
    ...
    it("gets javascript with printing instructions (JS action)", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue6106.pdf"));
      var promise = loadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getJavaScript();
      });
      promise.then(function (data) {
        expect(data).toEqual(["this.print({bUI:true,bSilent:false,bShrinkToFit:true});"]);
        expect(data[0]).toMatch(_ui_utils_metapdf.AutoPrintRegExp);
        loadingTask.destroy().then(done);
      })["catch"](done.fail);
    });
    ...
    it("gets outline containing a url", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue3214.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
    ...
    it("gets permissions", function (done) {
      var loadingTask0 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue9972-1.pdf"));
      var promise0 = loadingTask0.promise.then(function (pdfDoc) {
        return pdfDoc.getPermissions();
      });
      var loadingTask1 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue9972-2.pdf"));
      var promise1 = loadingTask1.promise.then(function (pdfDoc) {
        return pdfDoc.getPermissions();
      });
      var loadingTask2 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue9972-3.pdf"));
      var promise2 = loadingTask2.promise.then(function (pdfDoc) {
        return pdfDoc.getPermissions();
      });
      var totalPermissionCount = Object.keys(_util_metapdf.PermissionFlag).length;
      Promise.all([promise0, promise1, promise2]).then(function (permissions) {
        ...
        expect(permissions[0].includes(_util_metapdf.PermissionFlag.MODIFY_CONTENTS)).toBeFalsy();
        expect(permissions[1].length).toEqual(totalPermissionCount - 2);
        expect(permissions[1].includes(_util_metapdf.PermissionFlag.PRINT)).toBeFalsy();
        expect(permissions[1].includes(_util_metapdf.PermissionFlag.PRINT_HIGH_QUALITY)).toBeFalsy();
        expect(permissions[2].length).toEqual(totalPermissionCount - 1);
        expect(permissions[2].includes(_util_metapdf.PermissionFlag.COPY)).toBeFalsy();
    ...
    it("gets metadata, with missing PDF header (bug 1606566)", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("bug1606566.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getMetadata();
      }).then(function (_ref3) {
        var info = _ref3.info,
            metadata = _ref3.metadata,
            contentDispositionFilename = _ref3.contentDispositionFilename;
    ...
    it("gets markInfo", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("annotation-line.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
    ...
    it("checks that fingerprints are unique", function (done) {
      var loadingTask1 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue4436r.pdf"));
      var loadingTask2 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue4575.pdf"));
    ...
    describe("Cross-origin", function () {
      ...
      function _checkCanLoad(expectSuccess, filename, options) {
        ...
        params.url = url.href;
        loadingTask = (0, _api_metapdf.getDocument)(params);
  ...
  describe("Page", function () {
    ...
    it("gets view, with empty/invalid bounding boxes", function (done) {
      var viewLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("boundingBox_invalid.pdf"));
      viewLoadingTask.promise.then(function (pdfDoc) {
        ...
        Promise.all(viewPromises).then(function (_ref4) {
    ...
    it("gets annotations containing relative URLs (bug 766086)", function (done) {
      ...
      var defaultLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename));
      var defaultPromise = defaultLoadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getPage(1).then(function (pdfPage) {
          return pdfPage.getAnnotations();
        });
      });
      var docBaseUrlLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename, {
      ...
      var invalidDocBaseUrlLoadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)(filename, {
    ...
    it("gets text content, with correct properties (issue 8276)", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue8276_reduced.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
        pdfDoc.getPage(1).then(function (pdfPage) {
          pdfPage.getTextContent().then(function (_ref6) {
    ...
    it("gets operatorList with JPEG image (issue 4888)", function (done) {
      var loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("cmykjpeg.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
        pdfDoc.getPage(1).then(function (pdfPage) {
          pdfPage.getOperatorList().then(function (opList) {
            var imgIndex = opList.fnArray.indexOf(_util_metapdf.OPS.paintImageXObject);
    ...
    it("gets operatorList, from corrupt PDF file (issue 8702), " + "with/without `stopAtErrors` set", function (done) {
      var loadingTask1 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue8702.pdf", {
        stopAtErrors: false
      }));
      var loadingTask2 = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue8702.pdf", {
        stopAtErrors: true
      }));
    ...
    it("gets document stats after parsing page", function (done) {
      ...
      expectedStreamTypes[_util_metapdf.StreamType.FLATE] = true;
      var expectedFontTypes = {};
      expectedFontTypes[_util_metapdf.FontType.TYPE1] = true;
      expectedFontTypes[_util_metapdf.FontType.CIDFONTTYPE2] = true;
      promise.then(function (stats) {
        expect(stats).toEqual({
    ...
    it("caches image resources at the document/page level as expected (issue 11878)", /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(done) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                loadingTask = (0, _api_metapdf.getDocument)((0, _test_utils.buildGetDocumentParams)("issue11878.pdf"));
                firstImgData = null;
                _context.prev = 3;
                _context.next = 6;
              ...
              case 14:
                ...
                imgIndex = opList.fnArray.indexOf(_util_metapdf.OPS.paintImageXObject);
                ...
                if (i === 1) {
                  ...
                  expect(firstImgData.kind).toEqual(_util_metapdf.ImageKind.RGB_24BPP);
  ...
  describe("Multiple `getDocument` instances", function () {
    ...
    function renderPDF(_x2) {
      return _renderPDF.apply(this, arguments);
    }

    function _renderPDF() {
      _renderPDF = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee2(filename) {
        var loadingTask, pdf, page, viewport, canvasAndCtx, renderTask, data;
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                loadingTask = (0, _api_metapdf.getDocument)(filename);
  ...
  describe("PDFDataRangeTransport", function () {
    ...
    it("should fetch document info and page using ranges", function (done) {
      ...
      dataPromise.then(function (data) {
        ...
        var transport = new _api_metapdf.PDFDataRangeTransport(data.length, initialData);
        ...
        loadingTask = (0, _api_metapdf.getDocument)(transport);
        return loadingTask.promise;
    ...
    it("should fetch document info and page, without range, " + "using complete initialData", function (done) {
      var fetches = 0,
          loadingTask;
      dataPromise.then(function (data) {
        var transport = new _api_metapdf.PDFDataRangeTransport(data.length, data, true);

        transport.requestDataRange = function (begin, end) {
          fetches++;
        };

        loadingTask = (0, _api_metapdf.getDocument)({
          disableRange: true,
          range: transport
        });
        return loadingTask.promise;
