...
describe("ui_utils", function () {
  describe("binary search", function () {
    ...
    it("empty array", function () {
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([], isTrue)).toEqual(0);
    });
    it("single boolean entry", function () {
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([false], isTrue)).toEqual(1);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([true], isTrue)).toEqual(0);
    });
    it("three boolean entries", function () {
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([true, true, true], isTrue)).toEqual(0);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([false, true, true], isTrue)).toEqual(1);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([false, false, true], isTrue)).toEqual(2);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([false, false, false], isTrue)).toEqual(3);
    });
    it("three numeric entries", function () {
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([0, 1, 2], isGreater3)).toEqual(3);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([2, 3, 4], isGreater3)).toEqual(2);
      expect((0, _ui_utils_metapdf.binarySearchFirstItem)([4, 5, 6], isGreater3)).toEqual(0);
    });
  });
  describe("getPDFFileNameFromURL", function () {
    it("gets PDF filename", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/file1.pdf")).toEqual("file1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/pdfs/file2.pdf")).toEqual("file2.pdf");
    });
    it("gets fallback filename", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/file1.txt")).toEqual("document.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/pdfs/file2.txt")).toEqual("document.pdf");
    });
    it("gets custom fallback filename", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/file1.txt", "qwerty1.pdf")).toEqual("qwerty1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/pdfs/file2.txt", "qwerty2.pdf")).toEqual("qwerty2.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/file3.txt", "")).toEqual("");
    });
    it("gets fallback filename when url is not a string", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(null)).toEqual("document.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(null, "file.pdf")).toEqual("file.pdf");
    });
    ...
    it("gets PDF filename from query string", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/pdfs.html?name=file1.pdf")).toEqual("file1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/pdfs/pdf.html?file2.pdf")).toEqual("file2.pdf");
    });
    ...
    it("gets correct PDF filename when multiple ones are present", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/file1.pdf?name=file.pdf")).toEqual("file1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/pdfs/file2.pdf#file.pdf")).toEqual("file2.pdf");
    });
    it("gets PDF filename from URI-encoded data", function () {
      var encodedUrl = encodeURIComponent("http://www.example.com/pdfs/file1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(encodedUrl)).toEqual("file1.pdf");
      var encodedUrlWithQuery = encodeURIComponent("http://www.example.com/pdfs/file.txt?file2.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(encodedUrlWithQuery)).toEqual("file2.pdf");
    });
    it("gets PDF filename from data mistaken for URI-encoded", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/%AA.pdf")).toEqual("%AA.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("/pdfs/%2F.pdf")).toEqual("%2F.pdf");
    });
    it("gets PDF filename from (some) standard protocols", function () {
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("http://www.example.com/file1.pdf")).toEqual("file1.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("https://www.example.com/file2.pdf")).toEqual("file2.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("file:///path/to/files/file3.pdf")).toEqual("file3.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("ftp://www.example.com/file4.pdf")).toEqual("file4.pdf");
    });
    it('gets PDF filename from query string appended to "blob:" URL', function () {
      ...
      var blobUrl = (0, _util_metapdf.createObjectURL)(typedArray, "application/pdf");
      expect(blobUrl.startsWith("blob:")).toEqual(true);
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(blobUrl + "?file.pdf")).toEqual("file.pdf");
    });
    it('gets fallback filename from query string appended to "data:" URL', function () {
      var typedArray = new Uint8Array([1, 2, 3, 4, 5]);
      var dataUrl = (0, _util_metapdf.createObjectURL)(typedArray, "application/pdf", true);
      expect(dataUrl.startsWith("data:")).toEqual(true);
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)(dataUrl + "?file1.pdf")).toEqual("document.pdf");
      expect((0, _ui_utils_metapdf.getPDFFileNameFromURL)("     " + dataUrl + "?file2.pdf")).toEqual("document.pdf");
    });
  });
  describe("EventBus", function () {
    it("dispatch event", function () {
      var eventBus = new _ui_utils_metapdf.EventBus();
      var count = 0;
  ...
  describe("isValidRotation", function () {
    it("should reject non-integer angles", function () {
      expect((0, _ui_utils_metapdf.isValidRotation)()).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)(null)).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)(NaN)).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)([90])).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)("90")).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)(90.5)).toEqual(false);
    });
    it("should reject non-multiple of 90 degree angles", function () {
      expect((0, _ui_utils_metapdf.isValidRotation)(45)).toEqual(false);
      expect((0, _ui_utils_metapdf.isValidRotation)(-123)).toEqual(false);
    });
    it("should accept valid angles", function () {
      expect((0, _ui_utils_metapdf.isValidRotation)(0)).toEqual(true);
      expect((0, _ui_utils_metapdf.isValidRotation)(90)).toEqual(true);
      expect((0, _ui_utils_metapdf.isValidRotation)(-270)).toEqual(true);
      expect((0, _ui_utils_metapdf.isValidRotation)(540)).toEqual(true);
    });
  });
  describe("isPortraitOrientation", function () {
    it("should be portrait orientation", function () {
      expect((0, _ui_utils_metapdf.isPortraitOrientation)({
        width: 200,
        height: 400
      })).toEqual(true);
      expect((0, _ui_utils_metapdf.isPortraitOrientation)({
  ...
  describe("waitOnEventOrTimeout", function () {
    ...
    beforeAll(function (done) {
      eventBus = new _ui_utils_metapdf.EventBus();
      done();
    });
    afterAll(function () {
      eventBus = null;
    ...
    it("should reject invalid parameters", function (done) {
      var invalidTarget = (0, _ui_utils_metapdf.waitOnEventOrTimeout)({
        target: "window",
      ...
      var invalidName = (0, _ui_utils_metapdf.waitOnEventOrTimeout)({
        target: eventBus,
        name: ""
      }).then(function () {
        throw new Error("Should reject invalid parameters.");
      ...
      var invalidDelay = (0, _ui_utils_metapdf.waitOnEventOrTimeout)({
        target: eventBus,
        name: "pagerendered",
        delay: -1000
      }).then(function () {
    ...
    it("should resolve on event, using the DOM", function (done) {
      ...
      var buttonClicked = (0, _ui_utils_metapdf.waitOnEventOrTimeout)({
        target: button,
        name: "click",
        delay: 10000
      });
      ...
      buttonClicked.then(function (type) {
        expect(type).toEqual(_ui_utils_metapdf.WaitOnType.EVENT);
        done();
      }, done.fail);
    });
    it("should resolve on timeout, using the DOM", function (done) {
      ...
      buttonClicked.then(function (type) {
        expect(type).toEqual(_ui_utils_metapdf.WaitOnType.TIMEOUT);
        done();
      }, done.fail);
    });
    it("should resolve on event, using the EventBus", function (done) {
      var pageRendered = (0, _ui_utils_metapdf.waitOnEventOrTimeout)({
        target: eventBus,
        name: "pagerendered",
        delay: 10000
      });
  ...
  describe("getPageSizeInches", function () {
    it("gets page size (in inches)", function () {
      ...
      var _getPageSizeInches = (0, _ui_utils_metapdf.getPageSizeInches)(page),
    ...
    it("gets page size (in inches), for non-default /Rotate entry", function () {
      ...
      var _getPageSizeInches2 = (0, _ui_utils_metapdf.getPageSizeInches)(pdfPage1),
      ...
      var _getPageSizeInches3 = (0, _ui_utils_metapdf.getPageSizeInches)(pdfPage2),
  ...
  describe("getVisibleElements", function () {
    ...
    function scrollOverDocument(pages) {
      ...
      for (var i = -size; i < size; i += 7) {
        for (var j = i + 5; j < size; j += j - i) {
          ...
          expect((0, _ui_utils_metapdf.getVisibleElements)({
            scrollEl: scrollEl,
            views: pages,
    ...
    it("handles `sortByVisibility` correctly", function () {
      ...
      var visible = (0, _ui_utils_metapdf.getVisibleElements)({
        scrollEl: scrollEl,
        views: views
      });
      var visibleSorted = (0, _ui_utils_metapdf.getVisibleElements)({
        scrollEl: scrollEl,
        views: views,
    ...
    describe("backtrackBeforeAllVisibleElements", function () {
      ...
      it("handles case 1", function () {
        ...
        var bsResult = 4;
        expect((0, _ui_utils_metapdf.backtrackBeforeAllVisibleElements)(bsResult, pages, top1)).toEqual(4);
      });
      ...
      it("handles case 4", function () {
        var pages = makePages([[[10, 20], [10, 20], [10, 20], [10, 20]], [tallPage, shortPage, tallPage, shortPage], [[10, 50], [10, 50], [10, 50], [10, 50]], [[10, 20], [10, 20], [10, 20], [10, 20]]]);
        var bsResult = 4;
        expect((0, _ui_utils_metapdf.backtrackBeforeAllVisibleElements)(bsResult, pages, top2)).toEqual(4);
      });
    });
  });
  describe("moveToEndOfArray", function () {
    it("works on empty arrays", function () {
      var data = [];
      (0, _ui_utils_metapdf.moveToEndOfArray)(data, function () {});
      expect(data).toEqual([]);
    });
    ...
    it("works when moving some things", function () {
      var data = [1, 2, 3, 4, 5];
      (0, _ui_utils_metapdf.moveToEndOfArray)(data, function (x) {
        return x % 2 === 0;
      });
